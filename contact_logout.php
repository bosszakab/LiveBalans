...
<html lang="en">
  ...
  <body>
    ...
    <div class="page-heading header-text">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1>ติดต่อพวกเรา</h1>
            <span>อย่าลังเลที่จะส่งข้อความถึงเราตอนนี้!</span>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="contact-item">
              ...
              <h4>เบอร์โทร</h4>
              <p>สามารถโทรได้ที่เบอร์.</p>
              <a href="tel:093-762-1390">+6693 762 1390</a>
            </div>
          </div>
          <div class="col-md-4">
            <div class="contact-item">
              ...
              <h4>อีเมล</h4>
              <p>สามารถส่งข้อความได้ที่อีเมล.</p>
              <a href="mailto:LiveBalans@@gmail.com">LiveBalans@gmail.com</a>
            </div>
          </div>
          <div class="col-md-4">
            <div class="contact-item">
              <i class="fa fa-map-marker"></i>
              <h4>ตำแหน่งที่อยู่</h4>
              <p>280 ซ. นภาลัย 12 บางนาเหนือ เขตบางนา กรุงเทพมหานคร 10260<br> TH</p>
              <a href="https://maps.app.goo.gl/ohuYDmzQ7gzyjoni7">ดูบนแผนที่</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              <h2>ส่งข้อความถึง<em>พวกเรา</em></h2>
              <span>สามารถส่งข้อความเพื่อสอบถามข้อมูลเพิ่มเติม</span>
            </div>
          </div>
          <div class="col-md-12">
            <div class="contact-form">
              <form id="contact" action="" method="get">
                <div class="row">
                  ...
                  <div class="col-lg-4 col-md-12 col-sm-12">
                    <fieldset>
                      <input name="subject" type="text" class="form-control" id="subject" placeholder="ชื่อเรื่อง" required="">
                    </fieldset>
                  </div>
                  <div class="col-lg-12">
                    <fieldset>
    ...
    <div id="แผนที่">
      ...
      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1370.6273510437!2d100.59975595900693!3d13.674808040425326!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30e2a018011db771%3A0x63b41d477056101b!2z4Lin4Li04LiX4Lii4Liy4Lil4Lix4Lii4LmA4LiX4LiE4LmC4LiZ4LmC4Lil4Lii4Li14Lit4Lij4Lij4LiW4Lin4Li04LiX4Lii4LmM4Lie4LiT4Li04LiK4Lii4LiB4Liy4Lij!5e0!3m2!1sth!2sth!4v1699995373210!5m2!1sth!2sth" width="100%" height="500px" frameborder="0" style="border:0" allowfullscreen></iframe>
    </div>
