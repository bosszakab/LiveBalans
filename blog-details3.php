  ...
  <body>
    ...
    <div class="page-heading header-text">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1>ขั้นตอนการผิตตัวต้นแบบของทาง Whey protein LiveBalans</h1>
            <span>27.07.2020 15:10</span>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="more-info-content">
          <div class="right-content">
            <div class="center-content">
              <img src="assets/images/Machine3.jpg" class="img-fluid" alt="">
            </div>
            <br>
            <p>เป็นบริษัทรับผลิตเครื่องสำอาง อาหารเสริม และสกินแคร์ทุกชนิด เรารับวางแผนการตลาด สร้างแบรนด์ เรียกได้ว่าบริษัทของเรามีบริการแบบ One Stop Service ดูแลคุณตั้งแต่เริ่มอยากผลิตสินค้า สร้างแบรนด์ของตัวเอง จนถึงส่งขายออกสู่ตลาด โดยมีวัตถุประสงค์ ในการรับจ้างผลิตเครื่องสำอางที่มีคุณภาพดี ตรงตามความต้องการของลูกค้า รวดเร็ว ถูกใจ และทันตามการวางแผนการโปรโมทสินค้าตรงตามที่ลูกค้ากำหนด</p>

            <p>เราเป็นพันธมิตรกับโรงงานผลิตสกินแคร์ อาหารเสริม เครื่องสำอาง ครีม ในประเทศเกาหลีใต้ ที่ผลิตสินค้าให้กับแบรนด์ดังในเกาหลีมากมาย หากคุณต้องการเป็นเจ้าของแบรนด์สินค้าคุณภาพ มีนวัตกรรม ภายใต้ชื่อแบรนด์ของตัวเอง ติดต่อเรามาได้ทันที เรารับผลิตสกินแคร์ อาหารเสริม เครื่องสำอาง ครีมจากประสบการณ์หลายปี ทำให้เราสามารถเลือกโรงงานที่มีมาตรฐาน และเชี่ยวชาญในการผลิตกลุ่มสินค้า ที่คุณต้องการผลิตมากที่สุดได้ ทำให้คุณลูกค้าได้รับสินค้าที่ดี มีคุณภาพ โดเด่น มีจุดขาย ภายใต้ชื่อแบรนด์ Made In Korea ของตัวเอง ในงบประมาณที่คุณสามารถนำไปทำกำไรต่อได้อย่างมากมาย</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              <h2>ออก<em>ความคิดเห็น</em></h2>
              <span>ให้คุณช่วยเราในการแสดงความคิดเห็นต่างๆ</span>
            </div>
          </div>
          <div class="col-md-12">
              ...
              <form id="contact" action="" method="get">
                <div class="row">
                  <div class="col-lg-6 col-md-12 col-sm-12">
                    <fieldset>
                      <input name="name" type="text" class="form-control" id="name" placeholder="ชื่อจริง-นามสกุล" required="">
                    </fieldset>
                  </div>
                  <div class="col-lg-6 col-md-12 col-sm-12">
                    <fieldset>
                  ...
                  <div class="col-lg-12">
                    <fieldset>
                      <button type="submit" id="form-submit" class="filled-button">ยืนยัน</button>
                    </fieldset>
                  </div>
                </div>
              </form>
