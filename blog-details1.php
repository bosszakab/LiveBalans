  ...
  <body>
    ...
    <div class="page-heading header-text">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1>เครื่องกลที่ได้รับรองจากหลายบริษัทชั้นนำและหลายมหาวิทยาลัย</h1>
            <span>27.07.2020 10:10</span>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="more-info-content">
          <div class="right-content">
            <div class="center-content">
              <img src="assets/images/Machine.jpg" class="img-fluid" alt="">
            </div>
            <br>
            ...
            <h4>เราช่วยให้คุณเป็นเจ้าของกิจการแบบง่ายๆและไม่ต้องใช้ทุนมาก</h4>

            <br>

            <p>รับรองการผลิตด้วยมาตรฐานสากลระดับโลก GMP / HACCP / HALAL จึงมั่นใจได้ว่าผลิตภัณฑ์ทุกชิ้นของเราคุณภาพสูงสุด , ปลอดภัย และใช้แล้วได้ผลจริง นอกจากนั้นเรายังให้ความสำคัญในด้านการบริการ เพื่ออำนวยความสะดวกและตอบโจทย์ทุกข้อให้แก่ลูกค้าเพื่อธุรกิจที่เพิ่งเริ่มจะได้ทำง่ายขึ้น</p>
