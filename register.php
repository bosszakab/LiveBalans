        ...
        if(!empty($email) && !empty($password)){
            if($rowCount > 0){
                ...
                if($result){
                    ...
                    $mail->isSMTP();
                    $mail->Host='thanawat.jenphaet.th@gmail.com';
                    $mail->Port=587;
                    $mail->SMTPAuth=true;
                    $mail->SMTPSecure='tls';
    
                    $mail->Username='thanawat.jenphaet.th@gmail.com';
                    $mail->Password='S1662546m';
    
                    $mail->setFrom('thanawat.jenphaet.th@gmail.com', 'OTP Verification');
