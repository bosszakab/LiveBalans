  ...
  <body>
    ...
    <div class="page-heading header-text">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1>เกี่ยวกกับพวกเรา</h1>
            <span>เรามีประสบการณ์มากกว่า 5 ปี</span>
          </div>
        </div>
      </div>
    </div>
              ...
              <div class="row">
                <div class="col-md-6 align-self-center">
                  <div class="right-content">
                    <span>ก้าวข้ามสู่ความสำเร็จไปอีกขั้น</span>
                    <h2>ทำความรู้จักกับบริษัทของเรา</em></h2>
                    <p>เรากำลังปฏิวัติรสชาติของโปรตีนจากพืช ผ่านการทดสอบมากกว่า 80 รอบ ทีม R&D ของเราได้พัฒนาโปรตีนจากพืชเจเนอเรชันใหม่ที่มีรสชาติอร่อยยิ่งขึ้นและบริโภคได้ง่ายขึ้นโดยไม่ต้องเติมน้ำตาล ด้วยความเชี่ยวชาญด้านโภชนาการที่เหมาะสมสำหรับชาวเอเชีย
                    <br><br>ซึ่ง 80% ของประชากรไม่สามารถทนต่อแลคโตสได้ ผู้เชี่ยวชาญของเราจึงได้สร้างสรรค์คอลเลกชั่นไลฟ์สไตล์ 6 รายการเพื่อให้แน่ใจว่าพวกเขาจะเป็นเพื่อนที่ดีที่สุดของคุณในทุกช่วงชีวิต</p>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="left-image">
                    <img src="assets/images/Lean.jpg" alt="">
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="left-content">
              <span>Whey protein ชนิดพืช</span>
              <h2>เป็นที่ยอมรับของหมู่ผู้คน<em>ของพลังโปรตีน!</em></h2>
              <p>เผยพลังอันทรงพลังของโปรตีน! เจาะลึกถึงคุณประโยชน์มากมายต่อสุขภาพของโปรตีนจากพืช ตั้งแต่การเจริญเติบโตของกล้ามเนื้อและการฟื้นตัวไปจนถึงการควบคุมน้ำหนัก 
              <br><br>ไม่ว่าคุณจะเป็นผู้ชื่นชอบการออกกำลังกาย ผู้ที่อยู่ระหว่างการลดน้ำหนัก หรือเพียงอยากรู้เกี่ยวกับโภชนาการ ค้นพบว่าโปรตีนเชคและผงสามารถช่วยเพิ่มสุขภาพและความเป็นอยู่ที่ดีของคุณได้อย่างไร</p>
            </div>
          </div>
          <div class="col-md-6 align-self-center">
            <div class="row">
              <div class="col-md-6">
                <div class="count-area-content">
                  ...
                  <div class="count-title">จุดหมายปลายทาง</div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="count-area-content">
                  <div class="count-digit">6280</div>
                  <div class="count-title">ลูกค้ามีความสุข</div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="count-area-content">
                  <div class="count-digit">115</div>
                  <div class="count-title">เมือง</div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="count-area-content">
                  <div class="count-digit">9</div>
                  <div class="count-title">แพ็คเกจ</div>
                </div>
              </div>
            </div>
          </div>
