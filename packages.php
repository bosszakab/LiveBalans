...
<html lang="en">
  ...
  <body>
    ...
    <br>
    <br>
    <form align="right" class="d-flex" method="POST" action="packages.php">
   ...
   <div class="row">
    ...
    <div class="col-md-3">
      ...
      <?php if ($row['amount'] > 0) { ?>
        ...
        <?php } ?>
      <a class="btn btn-outline-success" href="package-details1.php?id=<?=$row['pro_id']?>" role="button">รายละเอียด</a>
...
<nav aria-label="Page navigation example" class="mt-5">
  <ul class="pagination justify-content-center">
    <li class="page-item"><a class="page-link" href="packages.php?page=1">Previous</a></li>
    <?php for($i=1; $i<=$total_page; $i++) { ?>
    <li class="page-item"><a class="page-link" href="packages.php?page=<?=$i?>"><?= $i ?></a></li>
    <?php } ?>
    <li class="page-item"><a class="page-link" href="packages.php?page=<?=$total_page?>">Next</a></li>
  </ul>
</nav>
